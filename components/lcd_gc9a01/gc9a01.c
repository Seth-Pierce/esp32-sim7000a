...
#define GC9A01_WIDTH       				(240)   /*!< Width of the LCD */
#define GC9A01_HEIGHT      				(240)    /*!< Height of the LCD */
#define GC9A01_SPI_HOST    				(1)      /*!< SPI host on the ESP32-C3. Hardware limits us to SPI2 */
#define GC9A01_PIN_NUM_SCK 				(06)
#define GC9A01_PIN_NUM_MOSI 			(07)
#define GC9A01_PIN_NUM_CS 				(10)
#define GC9A01_PIN_NUM_DC 				(04)
#define GC9A01_SPI_SCK_FREQ_M 			(80)    
#define GC9A01_CONTROL_BACK_LIGHT_USED  (0)
#define GC9A01_PIN_NUM_BCKL 			(05)
#define GC9A01_RESET_USED 				(0)
#define GC9A01_PIN_NUM_RST 				(GPIO_NUM_NC)
#define GC9A01_BUFFER_MODE 				(1)
#define GC9A01_BUFFER_SCREEN_FAST_MODE  (1)
#define GC9A01_CONTROL_BACK_LIGHT_MODE  (0)
